...
\end{itemize}
\begin{figure}[h]
\includegraphics[width=0.49\columnwidth{}]{figures/examples/1_Place_de_Mexico,_75016.jpg}%
\hspace{0.015\columnwidth}%
\includegraphics[width=0.49\columnwidth{}]{figures/examples/1_Port_de_la_Bourdonnais,_75007.jpg}
...
\caption{Our custom CGAN trained on the Stanford dataset. Each column represents one random input to the generator. The rows represent: the average of all cities, Amsterdam, Washington D.C., Florence, Las Vegas and Manhattan.}
