...
\pic[shift={ (1.2,0,0) }] at (Grelu5-east)
{RightBandedBox={
		name=Gconv6,
		caption= ,
		xlabel={{ 16 },},
...
\pic[shift={ (1.5,0,0) }] at (Grelu8-east)
{RightBandedBox={
		name=Gconv9,
		caption= ,
		xlabel={{ 8 }},
...
\pic[shift={ (2,0,0) }] at (Grelu11-east)
{RightBandedBox={
		name=Gconv12,
		caption= ,
		xlabel={{ 4 }},
...
\pic[shift={ (3,0,0) }] at (Grelu14-east)
{Box={
		name=Gconv15,
		caption= ,
		xlabel={{ 2 }},
...
\pic[shift={(0.7,0,0)}] at (Dconv11-east) 
    {Box={
        name=Dconv14,
        caption= ,
        xlabel={{64, }},
